 ...
 * @author vselivanov
 */
public class GarbageVehicleFlagEncoder extends AbstractFlagEncoder {
     ...
     */
    public GarbageVehicleFlagEncoder() {
        this(5, 5, 0);
    }

    public GarbageVehicleFlagEncoder(String propertiesStr) {
        this((int) parseLong(propertiesStr, "speedBits", 5),
                parseDouble(propertiesStr, "speedFactor", 5),
                parseBoolean(propertiesStr, "turnCosts", false) ? 3 : 0);
    }

    public GarbageVehicleFlagEncoder(int speedBits, double speedFactor, int maxTurnCosts) {
    ...
    public long acceptWay(OSMWay way) {
        String gmValue = way.getTag("gm");
        if ("ignore".equals(gmValue)) {
            return 0;
        }
